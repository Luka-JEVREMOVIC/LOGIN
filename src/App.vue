<script setup>
  ...
  <script>
  const SUPABASE_URL = 'https://emrjsahthnynouenhpea.supabase.co'
  const SUPABASE_KEY = 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6ImVtcmpzYWh0aG55bm91ZW5ocGVhIiwicm9sZSI6ImFub24iLCJpYXQiOjE2NjI5OTI1MjAsImV4cCI6MTk3ODU2ODUyMH0.VWgDgHMeyJ424OKkqwDs-ebcRVtNj4SnU9eCwr0yenI'
